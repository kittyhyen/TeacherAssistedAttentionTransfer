...
def distillation(y, teacher_scores, labels, T, alpha): #y_s, y_t, targets, opt.temperature, opt.alpha
    p = F.log_softmax(y/T, dim=1) #y
    q = F.softmax(teacher_scores/T, dim=1) #soft labels
